...
.. toctree::
   ...
   Between two XiVO <interconnections/two_xivo>
   Through an operator <interconnections/through_operator>
   Multiple interconnections <interconnections/multiple>
   Through XiVO gateways <interconnections/gateways>
