...
* Abstract source plugin: `BaseSourcePlugin <https://github.com/wazo-pbx/xivo-dird/blob/master/wazo_dird/plugins/base_plugins.py#L67>`_
* Methods:
...
* Abstract service plugin: `BaseServicePlugin <https://github.com/wazo-pbx/xivo-dird/blob/master/wazo_dird/plugins/base_plugins.py#L21>`_
...
* Abstract view plugin: `BaseViewPlugin <https://github.com/wazo-pbx/xivo-dird/blob/master/wazo_dird/plugins/base_plugins.py#L52>`_
