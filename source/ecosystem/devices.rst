...
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
|                                            | T19P | T20P | T21P | T22P | T28P | T32G    | T38G | T41P | T42G | T46G | W52P |
+============================================+======+======+======+======+======+=========+======+======+======+======+======+
| Provisioning [1]_                          | Y    | Y    | Y    | Y    | NT   | NT [4]_ | Y    | Y    | Y    | Y    | NT   |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| H-A [3]_                                   | Y    | Y    | Y    | Y    | Y    | N       | N    | Y    | Y    | Y    | N    |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Directory XIVO                             | MN   | N    | MN   | MN   | SK   | NT      | SK   | MN   | MN   | N    | NT   |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Funckeys [2]_                              | N    | 2    | 2    | 3    | 16   | 3       | 16   | 15   | 15   | 27   | NT   |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
|                                            | **Supported programmable keys**                                               |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| User with supervision function             | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Group                                      | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Queue                                      | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Conference Room with supervision function  | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **General Functions**                                                                                                      |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Online call recording                      | N    | N    | N    | N    | N    | NYT     | N    | N    | N    | N    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Phone status                               | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Sound recording                            | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Call recording                             | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Incoming call filtering                    | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Do not disturb                             | N    | Y    | SK   | SK   | SK   | NYT     | SK   | SK   | SK   | SK   | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Group interception                         | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Listen to online calls                     | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Directory access                           | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Filtering Boss - Secretary                 | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Transfers Functions**                                                                                                    |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Blind transfer                             | N    | HK   | HK   | HK   | HK   | NYT     | HK   | SK   | SK   | HK   | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Indirect transfer                          | N    | HK   | N    | N    | N    | NYT     | N    | SK   | SK   | HK   | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Forwards Functions**                                                                                                     |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Disable all forwarding                     | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Enable/Disable forwarding on no answer     | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Enable/Disable forwarding on busy          | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Enable/Disable forwarding unconditional    | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Voicemail Functions**                                                                                                    |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Enable voicemail with supervision function | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Activate voicemail                         | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Reach the voicemail                        | N    | HK   | HK   | HK   | HK   | NYT     | HK   | HK   | HK   | HK   | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Delete messages from voicemail             | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Agent Functions**                                                                                                        |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Connect/Disconnect a static agent          | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Connect a static agent                     | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Disconnect a static agent                  | N    | Y    | Y    | Y    | Y    | NYT     | Y    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Parking Functions**                                                                                                      |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Parking                                    | N    | Y    | Y    | Y    | Y    | NYT     | N    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Parking position                           | N    | Y    | Y    | Y    | Y    | NYT     | N    | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| **Paging Functions**                                                                                                       |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
| Paging                                     | N    | Y    | Y    | Y    | Y    | NYT     | NYT  | Y    | Y    | Y    | NYT  |
+--------------------------------------------+------+------+------+------+------+---------+------+------+------+------+------+
