...
+============================================+========+=======+=======+=======+=======+=======+
| Provisioning [1]_                          | Y      | Y     | Y     | Y     | N     | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| H-A [3]_                                   | Y      | Y     | Y     | Y     | Y     | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Directory XIVO                             | HK     | FK    | HK    | HK    | NYT   | FK    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Funckeys [2]_                              | 12     | 5     | 18    | 16    | NT    | 15    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
|                                            |      **Supported programmable keys**           |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| User with supervision function             | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Group                                      | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Queue                                      | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Conference Room with supervision function  | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **General Functions**                                                                       |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Online call recording                      | Y      | N     | N     | N     | NYT   | N     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Phone status                               | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Sound recording                            | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Call recording                             | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Incoming call filtering                    | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Do not disturb                             | HK     | SK    | HK    | HK    | NYT   | HK    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Group interception                         | Y      | Y     | Y     | Y     | NYT   | N     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Listen to online calls                     | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Directory access                           | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Filtering Boss - Secretary                 | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Transfers Functions**                                                                     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Blind transfer                             | Y      | SK    | HK    | HK    | NYT   | HK    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Indirect transfer                          | Y      | SK    | HK    | HK    | NYT   | HK    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Forwards Functions**                                                                      |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Disable all forwarding                     | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Enable/Disable forwarding on no answer     | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Enable/Disable forwarding on busy          | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Enable/Disable forwarding unconditional    | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Voicemail Functions**                                                                     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Enable voicemail with supervision function | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Activate voicemail                         | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Reach the voicemail                        | HK     | HK    | HK    | HK    | NYT   | HK    |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Delete messages from voicemail             | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Agent Functions**                                                                         |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Connect/Disconnect a static agent          | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Connect a static agent                     | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Disconnect a static agent                  | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Parking Functions**                                                                       |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Parking                                    | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Parking position                           | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| **Paging Functions**                                                                        |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
| Paging                                     | Y      | Y     | Y     | Y     | NYT   | Y     |
+--------------------------------------------+--------+-------+-------+-------+-------+-------+
