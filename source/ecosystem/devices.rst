...
+============================================+=========+=========+=======+=========+=======+=========+=======+=======+
| Provisioning [1]_                          | N       | Y       | NT    | NT [4]_ | Y     | NT [4]_ | Y     | NT    |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| H-A [3]_                                   | N       | N       | N     | N       | N     | N       | N     | N     |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Directory XIVO                             | NT      | NT      | NT    | NT      | SK    | NT      | FK    | NT    |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Funckeys [2]_                              | 2       | 3       | 16    | 3       | 16    | NT      | 27    | NT    |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
|                                                      | **Supported programmable keys**                             |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| User with supervision function             | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Group                                      | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Queue                                      | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Conference Room with supervision function  | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **General Functions**                                                                                              |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Online call recording                      | N       | N       | Y     | NYT     | N     | NYT     | N     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Phone status                               | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Sound recording                            | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Call recording                             | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Incoming call filtering                    | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Do not disturb                             | N       | SK      | SK    | NYT     | SK    | NYT     | SK    | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Group interception                         | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Listen to online calls                     | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Directory access                           | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Filtering Boss - Secretary                 | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **Transfers Functions**                                                                                            |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
...
| **Forwards Functions**                                                                                             |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Disable all forwarding                     | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Enable/Disable forwarding on no answer     | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Enable/Disable forwarding on busy          | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Enable/Disable forwarding unconditional    | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **Voicemail Functions**                                                                                            |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Enable voicemail with supervision function | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Activate voicemail                         | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Reach the voicemail                        | N       | N       | HK    | NYT     | HK    | NYT     | HK    | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Delete messages from voicemail             | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **Agent Functions**                                                                                                |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Connect/Disconnect a static agent          | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Connect a static agent                     | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Disconnect a static agent                  | N       | N       | Y     | NYT     | Y     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **Parking Functions**                                                                                              |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Parking                                    | N       | N       | Y     | NYT     | N     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Parking position                           | N       | N       | Y     | NYT     | N     | NYT     | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| **Paging Functions**                                                                                               |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
| Paging                                     | N       | N       | Y     | NYT     | NYT   | N       | Y     | NYT   |
+--------------------------------------------+---------+---------+-------+---------+-------+---------+-------+-------+
