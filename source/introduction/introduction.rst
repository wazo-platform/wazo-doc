...
XiVO is free software. Most of its distinctive components, and XiVO as a whole, are distributed under the GPLv3 license. We are also working on a fully `Open XiVO Hardware <http://blog.xivo.fr/index.php?category/Hardware>`_.

For more information, see `XiVO and Open Source <https://wiki.xivo.fr/index.php/XiVO_Is_OpenSource>`_
