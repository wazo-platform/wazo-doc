...
.. warning:: The 1.1 API is currently under heavy discussion and development. It cannot be
   used on a production system as it is not yet implemented. Moreover anything currently documented about the 1.1 API is subject to change.
