...
| device_slot            | int    | Line's position on the device                                  |
+------------------------+--------+----------------------------------------------------------------+
| callerid               | string | Caller id that appears on a phone when calling. String must be |
...
+------------------------+-----------+----------------------------------------------------------------+
| username               | no        | SIP account username. Will be autogenerated when absent        |
+------------------------+-----------+----------------------------------------------------------------+
| secret                 | no        | SIP account password. Will be autogenerated when absent        |
+------------------------+-----------+----------------------------------------------------------------+
| provisioning_extension | no        | Numeric code used to provision a phone. Will be autogenerated  |
|                        |           | when absent                                                    |
+------------------------+-----------+----------------------------------------------------------------+
